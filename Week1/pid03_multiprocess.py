...
def make_coffee(customer_name):
    # ดึง PID ของหน่วยปรมวลผลนี้ (วึ่งจะแยกจากกันเด็ดขาด)
    pid = os.getpid()
    ...
    print(f"{ctime()} | [PID: {pid}] [TID: {thread_id}] [Thread Name: {thread_name}] ลูกค้า {customer_name}: ได้รับกาแฟแล้วจ้า! เย่ๆ")
